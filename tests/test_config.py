...
def test_config_load_defaults_when_missing(tmp_path, monkeypatch):
    ...
    result = load_config()
    assert result == {"camera_id": None, "version": 1, "no_camera": False, "hosted": False, "app_name": "Microscope", "theme": "macos-dark", "tolerance_warn": 0.10, "tolerance_fail": 0.25, "subpixel_method": "parabola", "max_sessions": 50, "session_ttl": 1800}
